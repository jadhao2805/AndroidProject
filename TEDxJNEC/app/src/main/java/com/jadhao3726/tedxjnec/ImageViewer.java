...
public class ImageViewer extends AppCompatActivity {
    ...
    ImageView imageView;
    View imageView1;
int logos[] = {R.drawable.gone,R.drawable.gthree,R.drawable.gfour,R.drawable.gtwo,R.drawable.gfive,R.drawable.gnine,R.drawable.gseven,R.drawable.geight,R.drawable.gten,R.drawable.geleven,R.drawable.gtwel,R.drawable.gfourteen,R.drawable.gfifteen,R.drawable.gsixteen,R.drawable.gseventieen,R.drawable.gtwentyfour,R.drawable.gtwentyfive,R.drawable.gtwentysix,R.drawable.geighteen};
    @Override
